---
title: Введение
description: Знакомство с курсом Java — устройство виртуальной машины, ООП, обработка ошибок и Generics. Обозначен план курса вплоть до коллекций, функционального программирования и работы с базами данных.
weight: 1
tags:
  - Java
  - 4 Семестр
