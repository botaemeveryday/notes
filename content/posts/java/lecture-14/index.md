---
title: Apache Kafka
description: Apache Kafka как распределённая платформа потоковой обработки событий. Рассматриваются применения — высокопроизводительные пайплайны данных, потоковая аналитика и интеграция систем.
weight: 14
tags:
  - Java
  - 4 Семестр
