---
title: Микросервисы
description: Микросервисная архитектура и преимущества независимого масштабирования сервисов. Обсуждается главная сложность перехода от монолита — изменение механизма взаимодействия компонентов.
weight: 13
tags:
  - Java
  - 4 Семестр
