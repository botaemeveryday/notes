---
title: JDBC и JPA
description: Работа с базами данных через JDBC и JPA в контексте трёхуровневой архитектуры Java EE приложений. Рассматриваются клиентский уровень, бизнес-логика и уровень доступа к данным.
weight: 5
tags:
  - Java
  - 4 Семестр
