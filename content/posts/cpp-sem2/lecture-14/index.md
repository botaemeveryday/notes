---
title: Type traits
description: Продолжение темы метапрограммирования через type traits вроде is_same. Показывается, как компилятор через специализации шаблонов выводит свойства типов ещё до запуска программы.
date: 2025-05-07
tags:
  - 2 семестр
