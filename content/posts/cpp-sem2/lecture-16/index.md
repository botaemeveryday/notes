...
description: Причины появления многопоточности, начиная с закона Мура и ограничений роста производительности процессоров. Вводятся базовые понятия потоков и параллельного выполнения.
date: 2025-05-21
tags:
  - 2 семестр
