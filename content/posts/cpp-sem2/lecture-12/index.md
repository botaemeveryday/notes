---
title: Tuple
description: Реализация собственного tuple с использованием шаблонной рекурсии по пакету типов. Разбирается доступ к N-му элементу и различие между TAD и CTAD.
date: 2025-04-23
tags:
  - 2 семестр
