---
title: Функторы
description: Функциональные объекты (функторы) как альтернатива обычным функциям и указателям на функции. Разбирается их применение в алгоритмах STL на примере реализации собственного remove.
date: 2025-02-19
tags:
  - 2 семестр
