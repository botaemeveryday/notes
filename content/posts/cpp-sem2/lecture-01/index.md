...
description: Идиома RAII и её роль в управлении ресурсами. Разбираются умные указатели unique_ptr и shared_ptr как способ автоматизировать освобождение памяти.
date: 2025-02-05
tags:
  - 2 семестр
