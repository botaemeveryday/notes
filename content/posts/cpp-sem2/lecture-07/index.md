---
title: Лямбды
description: Указатели на функции и переход к лямбда-выражениям как более гибкому способу передавать поведение. Разбираются захват переменных и области применения лямбд.
date: 2025-03-19
tags:
  - 2 семестр
