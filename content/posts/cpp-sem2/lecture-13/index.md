...
description: Введение в шаблонное метапрограммирование и вычисления на этапе компиляции. Разбирается порядок выбора специализаций шаблонов на примере собственной реализации is_same.
date: 2025-04-30
tags:
  - 2 семестр
