---
title: Аллокаторы
description: Аллокаторы как механизм управления выделением памяти для контейнеров STL. Объясняется, зачем они нужны и как можно написать собственный аллокатор.
date: 2025-02-26
tags:
  - 2 семестр
