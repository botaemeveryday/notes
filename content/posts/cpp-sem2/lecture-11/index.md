...
description: Вариативные шаблоны и пакеты параметров, появившиеся в C++11. Показывается рекурсивная обработка аргументов и возможности оператора развёртки пакета.
date: 2025-04-16
tags:
  - 2 семестр
