---
title: STL
description: Обзор Standard Template Library и её ключевых компонентов — контейнеров, итераторов и алгоритмов. Показано, как эти части работают вместе для обобщённой обработки данных.
date: 2025-02-12
tags:
  - 2 семестр
