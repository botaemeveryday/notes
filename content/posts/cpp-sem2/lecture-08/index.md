---
title: std::function
description: Пошаговая реализация собственного аналога std::function. Показывается, как через специализацию шаблона по сигнатуре вызова строится обёртка для произвольных вызываемых объектов.
date: 2025-03-26
tags:
  - 2 семестр
