---
title: Концепты
description: Concepts как современная замена SFINAE-трюков для ограничения шаблонных параметров. Объясняется, зачем нужны концепты и как они делают ограничения читаемыми.
date: 2025-05-14
tags:
  - 2 семестр
