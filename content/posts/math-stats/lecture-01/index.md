---
title: "Введение"
description: "Предмет математической статистики в сравнении с теорией вероятностей. Задаётся отправная точка курса и модель простейшей выборки, на которой строятся дальнейшие темы."
date: 2026-02-04
...
{{< anki-download lecture="resources/lecture-01.apkg" course="../resources/math-stats.apkg" >}}
