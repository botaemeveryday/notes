...
description: "Формальная постановка задачи проверки статистических гипотез, включая нулевую и альтернативную гипотезы. Разбираются базовые понятия критерия и ошибок первого и второго рода."
date: 2026-03-18
...
{{< anki-download lecture="resources/lecture-07.apkg" course="../resources/math-stats.apkg" >}}
