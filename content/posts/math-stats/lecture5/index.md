...
<div style="justify-content:space-around; display: flex">
  <a href="/posts/math-stats/lecture5/resources/anki1.apkg" class="btn rounded-full no-underline">
      <ion-icon name="copy-outline"></ion-icon>
      Карточки Анки (Л5)
  </a>
  <a href="/posts/math-stats/lecture5/resources/transcription.txt" class="btn rounded-full no-underline">
