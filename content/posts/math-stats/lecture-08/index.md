---
title: "Критерий о медиане"
description: "Продолжение темы статистических критериев на примере критерия о медиане для одной выборки. Разбирается постановка задачи и построение соответствующего теста."
date: 2026-03-25
...
{{< anki-download lecture="resources/lecture-08.apkg" course="../resources/math-stats.apkg" >}}
