...
description: "Точечное оценивание параметров распределения на модели простейшей выборки. Разбирается метод моментов как один из базовых способов построения оценок."
date: 2026-02-18
...
{{< anki-download lecture="resources/lecture-03.apkg" course="../resources/math-stats.apkg" >}}
