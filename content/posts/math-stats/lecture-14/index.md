---
title: "GLM"
description: "Обобщённые линейные модели для случаев, когда выходная переменная категориальная, а не количественная. Вводится критерий отношения правдоподобия для проверки гипотез в таких моделях."
date: 2026-05-06
