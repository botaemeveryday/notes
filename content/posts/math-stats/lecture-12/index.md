---
title: "Регрессия: интервалы"
description: "Доверительные интервалы и проверка гипотез для коэффициентов линейной регрессионной модели. Продолжается разбор линейной модели, начатый в предыдущей лекции."
date: 2026-04-22
...
{{< anki-download lecture="resources/lecture-12.apkg" course="../resources/math-stats.apkg" >}}
