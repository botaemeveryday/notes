...
description: "Расширение линейных моделей — однофакторный дисперсионный анализ, метод главных компонент и взвешенный МНК. Показывается, как эти техники решают частные случаи, где обычный МНК не подходит."
date: 2026-04-29
...
{{< anki-download lecture="resources/lecture-13.apkg" course="../resources/math-stats.apkg" >}}
