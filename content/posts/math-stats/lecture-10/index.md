---
title: "Тесты"
description: "Статистические тесты на примере критерия для коэффициента корреляции Пирсона. Разбирается постановка задачи и построение проверки гипотезы о наличии линейной связи между переменными."
date: 2026-04-08
