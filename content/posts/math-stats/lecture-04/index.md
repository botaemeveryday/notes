---
title: "Правдоподобие"
description: "Метод максимального правдоподобия и введение информации Фишера. Разбирается контрпример, показывающий, что асимптотическая нормальность оценки не влечёт её асимптотическую несмещённость."
date: 2026-02-25
