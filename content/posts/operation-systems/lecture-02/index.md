---
title: "Оверлеи"
description: "Переход от программ-монолитов к структурным программам, модулям и пакетам. Разбирается оверлейное программирование как способ исполнять код, превышающий объём доступной памяти."
date: 2026-02-11
tags:
