---
title: "Введение"
description: "Вводная лекция курса и первый этап эволюции операционных систем. Обсуждаются фундаментальные компромиссы вроде размена времени на память и то, зачем нужно понимать устройство ОС «под капотом»."
date: 2026-02-04
tags:
