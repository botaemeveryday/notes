---
title: "Архитектуры ядер"
description: "Ядро ОС как резидентный привилегированный компонент и компромисс между удобством и размером. Разбирается монолитная архитектура с разделением на main program, services и utilities."
date: 2026-03-11
tags:
