...
description: "Информационная и системная архитектура ОС как продолжение функциональной. Разбирается управление процессами через PCB и очереди планирования, а также управление памятью."
date: 2026-03-04
tags:
