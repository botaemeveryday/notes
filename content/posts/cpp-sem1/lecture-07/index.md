---
title: Абстракция
description: Введение в объектно-ориентированное программирование через понятия абстракции и инкапсуляции. Рассматривается инвариант класса и сокрытие деталей реализации.
weight: 7
tags:
