---
title: Шаблоны
description: Шаблоны классов и функций как инструмент обобщённого программирования. Рассматриваются параметризация типами и значениями и семейства функций и классов, генерируемых компилятором.
weight: 11
tags:
