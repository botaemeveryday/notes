---
title: Перегрузка
description: Перегрузка функций, методов и операторов в C++. Даётся классификация операторов и правила, по которым компилятор выбирает подходящую перегрузку.
date: 2025-09-05
tags:
