---
title: Полиморфизм
description: Динамический и статический полиморфизм в C++ через виртуальные функции. Объясняются позднее и раннее связывание и работа с объектами через единый интерфейс.
date: 2025-09-05
tags:
