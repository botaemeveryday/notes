---
title: Ссылки
description: Ссылки как альтернатива указателям, правила инициализации переменных и продление жизни временных объектов. Также разбираются перегрузка функций и именованные скоупы.
date: 2025-09-05
tags:
