---
title: Основы
description: Базовые понятия языка C++ — типы данных, идентификаторы и операторы. Разбираются операторы ветвления, циклы и объявление функций как первые строительные блоки программ.
date: 2024-09-09
tags:
