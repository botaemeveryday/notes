---
title: Память
description: Устройство памяти компьютера и архитектуры фон Неймана и Гарвардская. Рассматриваются уровни памяти от регистров до дисков и работа с памятью на уровне процесса.
date: 2025-09-05
tags:
