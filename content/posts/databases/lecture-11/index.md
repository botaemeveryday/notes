...
tags:
  - Базы Данных
  - 3 Семестр
description: Устройство распределённых баз данных и трёхзвенная архитектура из клиента, бэкенда и БД. Рассматриваются подходы к масштабированию и особенности работы с данными в распределённой среде.
authors:
  - name: notakeith
