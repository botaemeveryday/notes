...
description: Транзакции и свойства ACID, которые гарантируют надёжность операций с базой данных. Разбираются атомарность, согласованность, изолированность и устойчивость на конкретных примерах.
authors:
  - name: notakeith
